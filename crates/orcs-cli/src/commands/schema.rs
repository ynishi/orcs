...
use orcs_core::session::{
    ...
    MessageMetadata, MessageRole, Plan, StopCondition, SystemEventType,
};
use orcs_core::state::model::{AppState, OpenTab};
use orcs_core::workspace::model::{ProjectContext, TempFile, UploadedFile, Workspace, WorkspaceResources};
...
pub fn generate() -> Result<()> {
    ...
    let output_dir = workspace_root.join("orcs-desktop").join("src").join("bindings");
