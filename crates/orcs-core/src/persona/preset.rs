...
/// - **Jordan**: Product Design Lead - focuses on user experience and clarity
/// - **Alex**: Tech Lead - focuses on technical architecture and best practices
pub fn get_default_presets() -> Vec<Persona> {
    vec![
        Persona {
            id: Uuid::new_v4().to_string(),
            name: "Jordan".to_string(),
            role: "Product Design Lead".to_string(),
