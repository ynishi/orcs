...
/// Convert SessionV2_7_0 DTO to domain model.
impl IntoDomain<Session> for SessionV2_7_0 {
...
/// Convert domain model to SessionV2_7_0 DTO for persistence.
impl version_migrate::FromDomain<Session> for SessionV2_7_0 {
...
pub fn create_session_migrator() -> version_migrate::Migrator {
    ...
    // Register migration path: V1.0.0 -> V1.1.0 -> V2.0.0 -> V2.1.0 -> V2.2.0 -> V2.3.0 -> V2.4.0 -> V2.5.0 -> V2.6.0 -> V2.7.0 -> Session
