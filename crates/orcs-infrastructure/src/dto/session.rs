...
/// Convert SessionV2_4_0 DTO to domain model.
impl IntoDomain<Session> for SessionV2_4_0 {
...
/// Convert domain model to SessionV2_4_0 DTO for persistence.
impl version_migrate::FromDomain<Session> for SessionV2_4_0 {
...
///
/// The migrator handles automatic schema migration from V1.0.0 to V2.4.0
...
/// - V2.4.0 → Session: Converts DTO to domain model
///
/// # Example
///
/// ```ignore
...
pub fn create_session_migrator() -> version_migrate::Migrator {
    ...
    // Register migration path: V1.0.0 -> V1.1.0 -> V2.0.0 -> V2.1.0 -> V2.2.0 -> V2.3.0 -> V2.4.0 -> Session
